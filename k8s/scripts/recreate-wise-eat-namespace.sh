...
echo ""
echo "Note : si ECONNRESET Mongo/Redis persiste, ce n’est PAS le namespace —"
echo "       c’est Stunnel (TLS pods → :27018/:6382). Voir stunnel logs :"
echo "  sudo journalctl -u stunnel4 -n 30 --no-pager | grep -E 'mongodb-tls|Connection reset'"
